...
import com.softbankrobotics.qisdktutorials.ui.tutorials.perceptions.explorationmaprepresentation.ExplorationMapRepresentationTutorialActivity
...
internal class CategoriesRouter : CategoriesContract.Router {
    ...
    private fun getDestinationActivity(tutorialId: TutorialId): Class<out TutorialActivity> {
        ...
        return when (tutorialId) {
            ...
            TutorialId.EXPLORATION_MAP_REPRESENTATION -> ExplorationMapRepresentationTutorialActivity::class.java
        }
    }
}
